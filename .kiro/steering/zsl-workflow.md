...
Then invoke the `setup-zsl-superpowers` skill. Walk the user through all five sections (issue tracker, triage labels, domain docs, ship style, project board). Do not proceed to Phase 1 until setup is complete.
